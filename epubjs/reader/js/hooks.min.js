EPUBJS.Hooks.register("beforeChapterDisplay").endnotes = function (a, b) {
    var c = b.contents.querySelectorAll("a[href]"), d = Array.prototype.slice.call(c), e = "epub:type", f = "noteref", g = EPUBJS.core.folder(location.pathname), h = (g + EPUBJS.cssPath || g, {});
    EPUBJS.core.addCss(EPUBJS.cssPath + "popup.css", !1, b.render.document.head), d.forEach(function (a) {
        ...
        p == f && (j = a.getAttribute("href"), k = j.replace("#", ""), l = b.render.document.getElementById(k), a.addEventListener("mouseover", c, !1), a.addEventListener("mouseout", i, !1))
    }), a && a()
    ...
    var c = b.contents.querySelectorAll("img"), d = Array.prototype.slice.call(c), e = b.height;
    ...
    var c = b.contents.querySelectorAll("[transclusion]"), d = Array.prototype.slice.call(c);
